module UI.Components.CodeFlask exposing
    ( view
    , readonly, language, linenumbers
    )

{-|

@docs view
@docs readonly, language, linenumbers
...
view value attrs =
    Html.node "code-flask" (Html.Attributes.value value :: attrs) []
